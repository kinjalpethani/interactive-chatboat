I have developed interactive chatboat which is basically used to display dynamic data based on 
user's input. Please refer custom.js for api integration.
# convForm
...
* Dynamically create new questions (like using an API)! - please see the example code inside the html to understand how it works
